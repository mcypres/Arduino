...
// attachInterrupt(ANEMO_INTERUPT, anemoInterupt, RISING);
 ...
 /* mySensor = new SensorQMC5883( ptLogOutputSer,
                                myLogger,
                                DECLINAISON_DEG,
                                DECLINAISON_MIN,
                                ptEepromBuff->ini.x,
  ...
  mySensor = new SensorQMC5883( ptLogOutputSer,
                                ...
                                12345);
  if (mySensor==NULL)  {
        _LOG_PRINT(M, (char*)"ouverture SensorQMC5883  "," mySensor==NULL");                        
  }
/*  else{
    if (mySensor->getError()) {
  
      _LOG_PRINT(M, (char*)"ouverture SensorQMC5883  ", mySensor->getErrorMsg());
      delete mySensor;
      mySensor = NULL;
    } 
    else {
