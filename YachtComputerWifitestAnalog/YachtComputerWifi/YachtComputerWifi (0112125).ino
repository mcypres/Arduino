...
#define TIME_INTERVAL_GIROUETTE 500
...
/*  if (nextTimeBaro  < millis()) {
    ...
    nextTimeBaro=millis();+ TIME_INTERVAL_BAROMETRE;
  }*/
  
  // anemo girouette
  
 // if (nextTimeAnemo  < millis() ) {
    if (mySensor2 != NULL) {
 ...
 //   nextTimeAnemo=millis()+ TIME_INTERVAL_GIROUETTE;
//  }
...
void sendMsg(String msg){
 ...
 //static uint8_t mux_id = 0;
   ...
   // wifi.send(mux_id,(const uint8_t*)buffer, msg.length());
