...
SensorQMC5883::SensorQMC5883(float declinationAngleDegres,float declinationAnglemin,float xOffset,float yOffset,float zOffset,int id) {
...
float SensorQMC5883::getHeadingDegrees(){
	mag.getEvent(&event);
