...
SensorMagneto::SensorMagneto(Logger* myLogger):Sensor(myLogger){
...
SensorMagneto::SensorMagneto(Logger* myLogger,int declinationAngleDegres=0,float declinationAnglemin=0,float xOffset=0,float yOffset=0,float zOffset=0,int id=0) :Sensor(myLogger){
