...
public:
	SensorMagneto(Logger* myLogger);
	SensorMagneto(Logger* myLogger,int declinationAngleDegres,float declinationAnglemin,float xOffset,float yOffset,float zOffset,int id);
