    ...
    uint8_t    tcaScan(void){
      unsigned int  mask = 0x00;
        ...
        for (auto t = 0; t < NUM_TCA; t++) {
            ...
            for (address = 1; address < 127; address++ ) {
                ...
                if (!error) {
                    ...
                    if (address == HMC5883_ADRS) {
                          Serial.print("  HMC5883 found at address :");                          
                          Serial.println(t);
                        mask |= (1 << t);
                    }
                    else {
                        if (address == QMC5883_ADRS) {
                          Serial.print("  QMC5883 found at address :");                          
                          Serial.println(t);
                          mask |= (1 << t);
                        }
                        else{
            ...
            if (nDevices == 0) {
                Serial.print("tNo I2C devices found\n");
            }
        }
