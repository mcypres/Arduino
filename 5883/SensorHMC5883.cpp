...
SensorHMC5883::SensorHMC5883(HardwareSerial *ptOutputSer,
	...
	_LOG_PRINT(M, &"SensorHMC5883", "Start constructor");
	...
	_LOG_PRINT(M, &"SensorHMC5883 constructor", "HMC5883 start");
	//Serial.println("HMC5883 start");
	
	mag = Adafruit_HMC5883_Unified(id);
	init(mag);						
	_LOG_PRINT(M, &"SensorHMC5883 constructor","HMC5883 created");
}
...
String SensorHMC5883::getSensorDetail(){
 ...
 float SensorHMC5883::getHeadingDegrees(sensors_event_t event,
...
sensors_event_t  SensorHMC5883::getEvent(){
	_LOG_PRINT(V,"SensorHMC5883 getEvent :","Start");
	mag.getEvent(&event);
	_LOG_PRINT(V,"SensorHMC5883 getEvent :","end");
	return event;
}
